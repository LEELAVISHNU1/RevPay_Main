...
public class BusinessSummaryResponse {
    ...
    public double getTotalInvoiceRevenue() { return totalInvoiceRevenue; }
    public void setTotalInvoiceRevenue(double totalInvoiceRevenue) { this.totalInvoiceRevenue = totalInvoiceRevenue; }
}