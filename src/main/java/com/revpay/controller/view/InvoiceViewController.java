...
public class InvoiceViewController {
    ...
    // Opens the invoice creation page for business users
    @GetMapping("/invoice/create")
    public String createPage() {
        return "create-invoice";
    }

    // Creates a new invoice using form data and redirects to dashboard
    ...
    // Shows all invoices received by the user with available payment cards
    @GetMapping("/invoices")
    ...
    // Pays the selected invoice using card if provided, otherwise wallet
